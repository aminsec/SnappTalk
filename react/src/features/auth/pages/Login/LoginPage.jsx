...
function LoginPage({ initialStep = LOGIN_STEPS.LOGIN }) {
  ...
  const handleDebugLogin = async (email) => {
    ...
    try {
      ...
      toast.error(error?.message || 'Debug login failed.');
    } finally {
      setIsSubmitting(false);
    }
  };
        ...
        <div className={styles.form}>
          ...
          {activeStep === LOGIN_STEPS.LOGIN && (
            <>
              ...
              <form className={styles['form-inputs']} onSubmit={handleLoginSubmit} autoComplete="on">
                <Input
                  type="email"
                  name="email"
                  id="login-email"
          ...
          {activeStep === LOGIN_STEPS.SIGNUP && (
            <>
              ...
              <form className={styles['form-inputs']} onSubmit={handleSignupSubmit} autoComplete="on">
                <Input
                  type="text"
                  name="username"
                  id="signup-username"
          ...
          {activeStep === LOGIN_STEPS.VERIFY_NOTICE && (
            <>
              ...
              <h4 className={styles.Discription}>
                We sent a verification link to <strong>{formValues.email}</strong>. Please check your
